...
import { createGig } from '../../utilities/gigs-api'; 
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-wrap items-center justify-between -mx-4 mb-8 pb-6 border-b border-gray-400 border-opacity-20">
          <div className="w-full sm:w-auto px-4 mb-6 sm:mb-0">
            <h4 className="text-2xl font-bold tracking-wide text-white mb-1">Create a Gig</h4>
            <p className="text-sm text-gray-300">Put your skills to display on Perched.</p>
          </div>
              ...
              <div className="flex flex-wrap sm:flex-nowrap max-w-xl">
                ...
                <div className="w-full py-8 px-4 text-center border-dashed border border-gray-400 hover:border-white focus:border-blue-500 rounded-lg">
                  <div className="relative group h-14 w-14 mx-auto mb-4">
                    ...
                    <input className="absolute top-0 left-0 h-14 w-14 opacity-0" id="formInput1-4" type="file" name="photo" onChange={handlePhotoInput} />
                  </div>
