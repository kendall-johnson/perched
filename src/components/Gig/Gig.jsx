            ...
            <div className="w-full sm:w-1/2 xl:w-1/3 px-4 mb-8">
              <Link className="group block text-center" to={`/gigs/${gig._id}`}>
                <div className="h-64 mb-4 bg-blueGray-900 rounded-md">
                  <img className="img-fluid w-full h-full transform -translate-x-1 -translate-y-1 object-cover border-2 border-black rounded-md" src="https://i.imgur.com/YQpvMlb.jpg" alt=""/>
                </div>
